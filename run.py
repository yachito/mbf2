...
# fb me : https://m.facebook.com/Aliff.febriyan
...
yeahh=random.choice(["Alip XD","Boyyz Zuckerberg"])
def logo():
	os.system("clear")
	print(f"""          ╔╦╗┌┐ ┌─┐  ╔═╗┌┐ v.1.1
          ║║║├┴┐├┤───╠╣ ├┴┐
...
[*] Facebook : https://m.facebook.com/Aliff.febriyan
[*] WhatsApp : +6282164141394
[*] Script Name : mbf-fb
[*] Version : 1.1
